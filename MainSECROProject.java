...
public class MainSECROProject {
    ...
    public static void main(String args[]) {
        // code for to iterate or exit.
        int s = 1;
        SECRO(s);

    }

    public static void SECRO(int s) {
        ...
        System.out.println("Or Any other integer to continue");

        s = sc.nextInt();
        if (s == 8) {
            System.out.println("You Exited out of program");
            return;
        }
        SECRO(s);
        sc.close();
